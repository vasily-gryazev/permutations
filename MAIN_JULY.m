...
%%
n = 4; Z = mean(Chiout,4); Z = squeeze(Z(1,:,:));

figure
pcolor(Z)

% set(gca,'layer','top');
view(90,270);axis tight;shading interp; 
% colormap(b2r(min(min(Delta)), max(max(Delta)))); 
% colormap(b2r(0,1)); 
colormap jet
% caxis([0.3 1])
colorbar;  box on
set(gcf, 'Position', [200, 300, 700, 250]); set(gca,'FontSize', 13); 
yticklabels({'1','2','3','4','5','6','7','8'}); xticklabels({'0.5','1','1.5','2'})
ylabel('x/Dj'); xlabel('r/Dj')
% title(sprintf('SP%d',n))
